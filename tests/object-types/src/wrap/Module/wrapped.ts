...
export function method3Wrapped(argsBuf: ArrayBuffer, env_size: u32): ArrayBuffer {
...
export function method5Wrapped(argsBuf: ArrayBuffer, env_size: u32): ArrayBuffer {
