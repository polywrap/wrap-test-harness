...
export class Args_getKey {
  key: string;
  map: Map<string, i32>;
}

export function deserializegetKeyArgs(argsBuf: ArrayBuffer): Args_getKey {
...
export class Args_returnMap {
  map: Map<string, i32>;
}

export function deserializereturnMapArgs(argsBuf: ArrayBuffer): Args_returnMap {
