...
export function i8MethodWrapped(argsBuf: ArrayBuffer, env_size: u32): ArrayBuffer {
...
export function u8MethodWrapped(argsBuf: ArrayBuffer, env_size: u32): ArrayBuffer {
...
export function i16MethodWrapped(argsBuf: ArrayBuffer, env_size: u32): ArrayBuffer {
...
export function u16MethodWrapped(argsBuf: ArrayBuffer, env_size: u32): ArrayBuffer {
...
export function i32MethodWrapped(argsBuf: ArrayBuffer, env_size: u32): ArrayBuffer {
...
export function u32MethodWrapped(argsBuf: ArrayBuffer, env_size: u32): ArrayBuffer {
