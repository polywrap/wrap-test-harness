...
export class Args_i8Method {
  first: i8;
  second: i8;
}

export function deserializei8MethodArgs(argsBuf: ArrayBuffer): Args_i8Method {
...
export class Args_u8Method {
  first: u8;
  second: u8;
}

export function deserializeu8MethodArgs(argsBuf: ArrayBuffer): Args_u8Method {
...
export class Args_i16Method {
  first: i16;
  second: i16;
}

export function deserializei16MethodArgs(argsBuf: ArrayBuffer): Args_i16Method {
...
export class Args_u16Method {
  first: u16;
  second: u16;
}

export function deserializeu16MethodArgs(argsBuf: ArrayBuffer): Args_u16Method {
...
export class Args_i32Method {
  first: i32;
  second: i32;
}

export function deserializei32MethodArgs(argsBuf: ArrayBuffer): Args_i32Method {
...
export class Args_u32Method {
  first: u32;
  second: u32;
}

export function deserializeu32MethodArgs(argsBuf: ArrayBuffer): Args_u32Method {
