...
export class Args_boolMethod {
  arg: bool;
}

export function deserializeboolMethodArgs(argsBuf: ArrayBuffer): Args_boolMethod {
...
export class Args_intMethod {
  arg: i32;
}

export function deserializeintMethodArgs(argsBuf: ArrayBuffer): Args_intMethod {
...
export class Args_uIntMethod {
  arg: u32;
}

export function deserializeuIntMethodArgs(argsBuf: ArrayBuffer): Args_uIntMethod {
...
export class Args_bytesMethod {
  arg: ArrayBuffer;
}

export function deserializebytesMethodArgs(argsBuf: ArrayBuffer): Args_bytesMethod {
...
export class Args_arrayMethod {
  arg: Array<string>;
}

export function deserializearrayMethodArgs(argsBuf: ArrayBuffer): Args_arrayMethod {
...
export function writearrayMethodResult(writer: Write, result: Array<string> | null): void {
  ...
  writer.writeOptionalArray(result, (writer: Write, item: string): void => {
