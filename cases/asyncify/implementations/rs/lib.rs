...
impl ModuleTrait for Module {
    fn get_data(args: module::ArgsGetData) -> u32 {
    ...
    fn set_data_with_large_args(args: module::ArgsSetDataWithLargeArgs) -> String {
    ...
    fn set_data_with_many_args(args: module::ArgsSetDataWithManyArgs) -> String {
        let (
            args_a,
            args_b,
            args_c,
    ...
    fn local_var_method(args: module::ArgsLocalVarMethod) -> bool {
        match StorageModule::set_data(&storage_module::ArgsSetData {
            value: 88
        }) {
            Ok(_v) => true,
    ...
    fn global_var_method(args: module::ArgsGlobalVarMethod) -> bool {
        match StorageModule::set_data(&storage_module::ArgsSetData {
            value: 77
        }) {
            Ok(_v) => true,
    ...
    fn subsequent_invokes(args: module::ArgsSubsequentInvokes) -> Vec<String> {
