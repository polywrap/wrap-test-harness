...
impl ModuleTrait for Module {
    ...
    fn set_data_with_large_args(args: module::ArgsSetDataWithLargeArgs) -> Result<String, String> {
    ...
    fn set_data_with_many_args(args: module::ArgsSetDataWithManyArgs) -> Result<String, String> {
        let (
            args_a,
            args_b,
            args_c,
    ...
    fn local_var_method(args: module::ArgsLocalVarMethod) -> Result<bool, String> {
    ...
    fn global_var_method(args: module::ArgsGlobalVarMethod) -> Result<bool, String> {
    ...
    fn subsequent_invokes(args: module::ArgsSubsequentInvokes) -> Result<Vec<String>, String> {
